...
from deep_space_core.constants import MU_SUN, MU_EARTH, MU_MARS, R_EARTH, R_MARS, G0, DAY_S
from .hohmann import leo_to_lunar_transfer, hohmann_transfer
from deep_space_core.astrodynamics import lambert_universal
from .tsiolkovsky import propellant_mass, build_delta_v_budget
from trajectory_engine.earth_mars import get_planet_state, date_to_jd, jd_to_date
from trajectory_engine.asteroid import get_asteroid_state
    ...
    def _compute_delta_v(self):
        ...
        if self.destination == "Moon":
            ...
            try:
                ...
                # Solve Lambert
                v_trans1, v_trans2 = lambert_universal(rE, rM, dt_flight_s, MU_SUN, prograde=True)
            ...
            try:
                ...
                v_trans1, v_trans2 = lambert_universal(rE, rA, dt_flight_s, MU_SUN, prograde=True)
