...
from deep_space_core.constants import MU_SUN, MU_EARTH, DAY_S
from .earth_mars import get_planet_state, date_to_jd
from .asteroid import get_asteroid_state
...
def run_asteroid_simulation(asteroid_name="bennu", launch_date_str="2032-08-15", flight_days=350.0):
    ...
    v_trans_start, _ = lambert_universal(r_earth_start, r_ast_end, dt_s, MU_SUN, prograde=True)
