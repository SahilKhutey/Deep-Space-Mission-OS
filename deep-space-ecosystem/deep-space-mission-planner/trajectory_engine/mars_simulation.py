...
from deep_space_core.constants import MU_SUN, MU_EARTH, MU_MARS, DAY_S
...
def run_mars_simulation(launch_date_str="2032-08-15", flight_days=258.0):
    ...
    v_trans_start, _ = lambert_universal(r_earth_start, r_mars_end, dt_s, MU_SUN, prograde=True)
