...
def moon_n_body_dynamics(t, state, jd_start):
    ...
    try:
        ...
        # Moon attraction on spacecraft (softened) minus Moon attraction on Earth (standard indirect term)
...
def run_moon_simulation(launch_date_str="2032-08-15", flight_days=4.5):
    ...
    # We place it in the plane of the Moon's orbit for simplicity of transfer
    ...
    # Create a starting position vector in LEO inclined to match Moon plane
    r_sc_start = np.array([
...
def plot_moon_simulation(sim_data, save_path=None):
    ...
    # Plot Moon at departure and arrival
...
if __name__ == "__main__":
    data = run_moon_simulation()
    plot_moon_simulation(data, "simulations/outputs/moon_transfer_3d.png")
    print("Moon simulation plot saved successfully.")
